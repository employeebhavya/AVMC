...
export const Hero = () => {
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/60 via-black/40 to-transparent z-[5]"></div>
      ...
      <div className="container1 relative z-10 h-full flex items-center">
        <div className="text-left max-w-2xl">
          ...
          {/* Main Heading */}
          <h1 className="text-white text-4xl md:text-6xl font-bold mb-4 leading-tight drop-shadow-md">
